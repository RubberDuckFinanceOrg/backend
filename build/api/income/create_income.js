...
router.post('/income', authorization_1.default, json_validator_1.default({ body: income_schema_1.default }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const income = yield req.body;
        yield knex_models_1.Create('income', income);
        response_messages_1.default.createOk(res, 'income');
    }
    catch (err) {
