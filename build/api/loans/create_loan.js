...
router.post('/loans', authorization_1.default, json_validator_1.default({ body: loan_schema_1.default }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const loans = yield req.body;
        yield knex_models_1.Create('loans', loans);
        response_messages_1.default.createOk(res, 'loans');
    }
    catch (err) {
