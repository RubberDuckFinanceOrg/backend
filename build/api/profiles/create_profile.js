...
router.post('/profiles', authorization_1.default, json_validator_1.default({ body: profile_schema_1.default }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const profile = yield req.body;
        yield knex_models_1.Create('profiles', profile);
